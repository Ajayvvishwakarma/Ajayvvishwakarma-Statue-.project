...
//         magnifierSize = $(".magnifier").outerWidth() / 10;

//     $(".magnifier").show();
//     $(this).mousemove(function (e) {
//         var posX = e.pageX - imgPosition.left,
//             posY = e.pageY - imgPosition.top;
//         var percX = (posX / imgWidth) * 100,
//             percY = (posY / imgHeight) * 100,
//             perc = percX + "% " + percY + "%";
//         $(".magnifier").css({
//             top: posY - magnifierSize,
//             left: posX - magnifierSize,
...
//     var mediumImg = $(this).data('image');
//     var zoomImg = $(this).data('zoom-image');

//     // Update the magnifier background image
//     $('.magnifier').css('background-image', 'url(' + mediumImg + ')');

//     // Update the zoom image
//     $('.magnified img').attr('src', mediumImg);
//     $('.magnified img').attr('data-zoom-image', zoomImg);
// });

// $('.magnified img').elevateZoom({
//     zoomType: "lens",
//     lensShape: "round",
//     lensSize: 200,
// });

// $('.magnified img').removeData('elevateZoom');
...
// });
    ...
    var mediumImg = $(this).data('image'); // Get new medium image
    var zoomImg = $(this).data('zoom-image'); // Get new zoom image

    // Update the magnified image and magnifier's background
    $(".magnified img").attr('src', mediumImg);
...
$(".magnified").hover(function (e) {
    var imgPosition = $(".magnify").offset(),
        imgHeight = $(".magnified").height(),
        imgWidth = $(".magnified").width(),
        magnifierSize = $(".magnifier").outerWidth() / 20;
